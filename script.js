document.addEventListener("DOMContentLoaded", () => {
  const projectsData = {
    ...
    "dwarf-studio": {
      ...
      content: `
            ...
            `,
      images: [
        "../ressources/images/lookdev_exemple.PNG",
        "../ressources/images/hook_func.PNG",
      ],
    },
    internship: {
  ...
  // Créer la modal de détail du projet (fonction active)
  const createProjectDetail = () => {
    ...
    detailElement.innerHTML = `
            <div class="project-detail-content card">
                <button class="close-button btn btn-icon" aria-label="Fermer">&times;</button>
                <h2 class="project-detail-title"></h2>
                <div class="project-detail-body"></div>
            </div>
        `;
    // Basic styles for the modal (kept minimal; main styling lives in css)
